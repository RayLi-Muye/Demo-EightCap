    ...
    <ScreenScroll>
      ...
      >
        ...
        <Text selectable style={{ color: colors.muted, fontSize: 15, lineHeight: 23 }}>
          This project is a React Native interview demonstration inspired by Eightcap's public website. It is not affiliated with Eightcap, does not connect to live market feeds, and does not allow trading or account actions.
        </Text>
